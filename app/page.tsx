    ...
    <div className="w-full">
      ...
      <section className="pt-32 pb-24 px-4 text-center w-full max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link href="/journey" className="px-8 py-3.5 rounded-lg bg-purple-500 hover:bg-purple-600 text-white font-bold transition-all shadow-[0_0_20px_rgba(168,85,247,0.3)] border border-purple-400">
            🎬 The Data Journey
          </Link>
